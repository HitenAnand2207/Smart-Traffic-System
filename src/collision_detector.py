...
class CollisionDetector:
    ...
    def _detect_collisions(self, positions: Dict, detections: sv.Detections) -> List[Dict]:
        """
    ...
    def _calculate_collision_risk(self, pos1, vel1, pos2, vel2, box1, box2) -> float:
        ...
        # Risk calculation
        distance_risk = 1.0 - min(distance / min_safe_dist, 1.0) if distance < min_safe_dist else 0.0
    ...
    def get_alerts(self) -> List[Dict]:
        ...
        """
        return sorted(self.collision_alerts, key=lambda x: x['risk_score'], reverse=True)
